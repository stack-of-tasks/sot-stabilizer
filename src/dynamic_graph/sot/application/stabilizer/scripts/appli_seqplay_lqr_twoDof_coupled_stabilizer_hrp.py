...
appli.robot.addTrace( est.odometry.name,'nbSupport' )
appli.robot.addTrace( est.odometry.name,'supportPos1' )
appli.robot.addTrace( est.odometry.name,'supportPos2' )
appli.robot.addTrace( est.odometry.name,'homoSupportPos1' )
appli.robot.addTrace( est.odometry.name,'homoSupportPos2' )
appli.robot.addTrace( est.odometry.name,'forceSupport1' )
