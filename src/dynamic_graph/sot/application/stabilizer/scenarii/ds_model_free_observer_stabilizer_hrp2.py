...
from dynamic_graph.sot.application.stabilizer.scenarii.hrp2_model_free_observer_stabilizer import HRP2ModelFreeObserverStabilizer
from numpy import diag


class DSModelFreeObserverStabilizerHRP2(DSStabilizer):
    ...
    def createStabilizedCoMTask (self):
        task = HRP2ModelFreeObserverStabilizer(self.robot)
